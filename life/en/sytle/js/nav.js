$(function () {
    // 生成目录索引列表
    var temp_html = '<a name="dnttop"></a><div class="panel panel-info"><div class="panel-heading"><h4 class="panel-title">目录</h4></div><div class="panel-body">{dntnav}</div></div>';
    var h_list = $('.container h2,.container h3');//这边你可以自行修改
