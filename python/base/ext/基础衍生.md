- [1.Python基础语法扩展](#1python基础语法扩展)
    - [1.1.if 判断条件相关](#11if-判断条件相关)
    - [1.2.三元表达符](#12三元表达符)
    - [1.2.字符串和编码](#12字符串和编码)
    - [1.3.值判断和地址判断](#13值判断和地址判断)
- [2.Python总结之for系列](#2python总结之for系列)
    - [2.1.Base](#21base)
    - [2.2.列表生成式](#22列表生成式)
    - [2.3.扩展](#23扩展)
- [3.Python中赋值、浅拷贝、深拷贝](#3python中赋值浅拷贝深拷贝)
    - [3.1.赋值](#31赋值)
    - [3.2.深拷贝deepcopy](#32深拷贝deepcopy)
    - [3.3.浅拷贝copy](#33浅拷贝copy)
    - [3.4.知识扩展](#34知识扩展)
- [4.CSharp中赋值、浅拷贝、深拷贝](#4csharp中赋值浅拷贝深拷贝)
    - [4.1.赋值](#41赋值)
    - [4.2值类型默认深拷贝](#42值类型默认深拷贝)
    - [4.3.引用类型默认浅拷贝](#43引用类型默认浅拷贝)
    - [4.4.简单方式实现深拷贝](#44简单方式实现深拷贝)
    - [4.5.序列化方式实现深拷贝（常用）](#45序列化方式实现深拷贝常用)
- [5.Python生成器](#5python生成器)
    - [5.1.简单方式](#51简单方式)
    - [5.2.yield方式](#52yield方式)
    - [5.3.扩展之～`send(msg)`方法：](#53扩展之sendmsg方法)
    - [5.4.扩展之～`return`和`break`的说明](#54扩展之return和break的说明)
    - [5.5.扩展之～协程`yield`实现多任务调度](#55扩展之协程yield实现多任务调度)
- [6.Python迭代器](#6python迭代器)
    - [6.1.判断是否可迭代](#61判断是否可迭代)
    - [6.2.判断是否是迭代器](#62判断是否是迭代器)
    - [6.3.`Iterable` 转 `Iterator`](#63iterable-转-iterator)
- [7.CSharp迭代器](#7csharp迭代器)
    - [7.1.`IEnumerator` 和 `IEnumerable`](#71ienumerator-和-ienumerable)
    - [7.2.yield方式](#72yield方式)
- [8.闭包](#8闭包)
    - [8.1.Python闭包](#81python闭包)
    - [8.2.CSharp闭包](#82csharp闭包)
